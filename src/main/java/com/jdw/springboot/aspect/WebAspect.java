...
public class WebAspect {
    /**
     * 切入点
     * 匹配com.jdw.sys.controller包及其子包下的所有类的所有方法
     */
//    @Pointcut(value = "within(com.jdw.sys.controller.*)") 扫描类
//    @Pointcut(value = "@annotation(org.springframework.web.bind.annotation.GetMapping)") 扫描注解
    @Pointcut("execution(* com.jdw.sys.controller..*.*(..))")
     ...
     */
//    @Around("execution(* com.jdw.sys.controller.UserController.getUser(..))")

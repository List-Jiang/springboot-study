...
public class CodeGenerator {
    ...
    private static String projectPath = "D:\\temp";
    private static String author = "ListJiang";
    private static String schemaName = "public";
    private static String packageJava = "/src/main/java";
    private static String packageParent = "cn.jdw.shop";
    ...
    public static String scanner(String tip, boolean status) {
        if (status) {
    ...
    public static void main(String[] args) {
        ...
        if (status) {
            ...
            packageParent = "com.xzt.demo";

            // 全局配置
            GlobalConfig gc = new GlobalConfig();
            // String projectPath = System.getProperty("user.dir");
            gc.setOutputDir(projectPath + packageJava);
            gc.setAuthor(author);
            gc.setOpen(false);
...
//        gc.setServiceImplName("%sServiceImpl");
            ...
            pc.setModuleName(scanner("模块名", status));
        ...
        /*cfg.setFileCreate(new IFileCreate() {
            ...
            strategy.setInclude(scanner("表名，多个英文逗号分割", status).split(","));
